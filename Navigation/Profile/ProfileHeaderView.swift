...
class ProfileHeaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            // Constraints - setTitleButton/ProfilHeaderView
